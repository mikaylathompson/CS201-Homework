...
(define tm-times (list
                  '(q1 1 q1 1 r)
                  '(q1 c q2 c r)  ; Go to c.
                  
                  '(q2 1 q2 x r)
                  '(q2 b q3 b l)  ; Change 1's to x's.
                  
                  '(q3 1 q3 1 l)
                  '(q3 c q3 c l)
                  '(q3 x q3 x l)  ; Go all the way to the left
                  '(q3 b q4 b r)
                  
                  '(q4 1 q5 b r)  ; Delete the 1 on the end of the row.
                  '(q4 c q10 b r)
                  
                  '(q5 1 q5 1 r)
                  '(q5 c q5 c r)  ; Find c and change the next x to a y
                  '(q5 x q6 y r)
                  
                  '(q6 x q6 x r)
                  '(q6 1 q6 1 r)  ; Go to end of string, add a 1
                  '(q6 b q7 1 l)
                  
                  '(q7 x q7 x l)
                  '(q7 1 q7 1 l)  ; Go left to the y
                  '(q7 y q8 y r)
                  
                  '(q8 x q6 y r)  ; If the next sym is x, change to 9, go to q6
                  '(q8 1 q9 1 l)  ; If the next sym is 1, go to q9
                  
                  '(q9 y q9 x l)
                  '(q9 c q3 c l)  ; Clean up y's and go to q3
                  
                  '(q10 x q10 b r)  ; Clean up x's.
                  ))
