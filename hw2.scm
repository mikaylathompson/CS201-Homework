...
; (a) I ran match with 1000 games between short-move and random-move.
;     The results were 754 wins for short-move, 224 for random-move,
;     and 22 ties. Clearly, short-move is the better player, but it 
;     doesn't seem to be all that good if it's only 3 times better 
;     than a totally random player.
